            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-xs text-gray-400 font-medium">
                  Vui lòng chọn cổng thanh toán phù hợp
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <MethodSelector
                  id="CASH"
                  title={
                    orderType === 'delivery' ? 'Tiền mặt khi nhận hàng (COD)' : 'Tiền mặt tại quầy'
                  }
                  desc={
                    orderType === 'delivery'
                      ? 'Thanh toán trực tiếp cho shipper'
                      : 'Nhân viên hỗ trợ tại bàn'
                  }
        ...
        <div className="bg-gray-50 border border-gray-100 rounded-2xl p-4 text-xs space-y-2.5 font-medium text-left">
          ...
          <div className="flex justify-between border-b border-gray-200/50 pb-2">
            ...
            <span className="font-bold text-gray-900">
              {orderType === 'delivery' ? 'Giao hàng tận nơi' : 'Ăn tại bàn'}
            </span>
          </div>
